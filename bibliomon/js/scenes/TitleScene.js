class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(320, 150, 'BIBLIOMON', {
            fontFamily: 'monospace', fontSize: '32px', fill: '#ffcc00'
        }).setOrigin(0.5);

        this.add.text(320, 220, 'MMU Library Edition', {
        ...
        if (hasSave) {
            this.add.text(320, 320, 'Press 1 to CONTINUE', {
                fontFamily: 'monospace', fontSize: '14px', fill: '#ffffff'
            }).setOrigin(0.5);

            this.add.text(320, 360, 'Press 2 for NEW GAME', {
                fontFamily: 'monospace', fontSize: '14px', fill: '#ffffff'
            }).setOrigin(0.5);
            ...
            const startText = this.add.text(320, 340, 'Press ENTER to start', {
                fontFamily: 'monospace', fontSize: '14px', fill: '#ffffff'
            }).setOrigin(0.5);
